...
class AppList(MenuItem, AppListElementMixin):
    ...
    def init_with_context(self, context):
        ...
        super(AppList, self).init_with_context(context)
...
class ModelList(MenuItem, AppListElementMixin):
    ...
    def __init__(self, title=None, models=None, exclude=None, **kwargs):
        ...
        self.include_list = kwargs.pop('include_list', []) # deprecated
        self.exclude_list = kwargs.pop('exclude_list', []) # deprecated
        self.css_classes = ('module-menu',) + kwargs.get('css_classes', tuple())
    ...
    def init_with_context(self, context):
        ...
        for model, perms in items:
            ...
            self.children.append(item)
        super(ModelList, self).init_with_context(context)
...
class ModelItem(MenuItem):
    ...
    def init_with_context(self, context):
        ...
        self.url = reverse('%s:%s_%s_changelist' % (get_admin_site_name(context), app_label, self.model.__name__.lower()))