tinymce.PluginManager.add("image", function (e) {
    ...
    function i(n) {
        ...
        var p = [
            {name: "src", type: "filepicker", filetype: "image", label: "Source", autofocus: !0, onchange: s},
            f,
